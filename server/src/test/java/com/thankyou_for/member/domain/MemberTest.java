...
public class MemberTest {
    ...
    private static final String RESIDENT_REGISTRATION_NUMBER = "900101-1000000";
    ...
    public static Member testMemberWithAccount(int i, AccountStatus accountStatus) {
        ...
        member.addInitialAccount(new Account(ACCOUNT_HOLDER, ACCOUNT_NUMBER + i, RESIDENT_REGISTRATION_NUMBER, BANK_BOOK_URL,
                BANK, accountStatus));
        return member;
    }
    ...
    public void registerAccount() {
        ...
        //when
        member.registerAccount(ACCOUNT_HOLDER, ACCOUNT_NUMBER, RESIDENT_REGISTRATION_NUMBER, BANK, BANK_BOOK_URL);
    ...
    public void registerAccountWhenRequesting() {
        ...
        assertThatThrownBy(() -> member.registerAccount(ACCOUNT_HOLDER, ACCOUNT_NUMBER, RESIDENT_REGISTRATION_NUMBER,
                BANK, BANK_BOOK_URL))
